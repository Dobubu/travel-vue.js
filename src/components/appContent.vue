...
export default {
  ...
  methods: {
    ...
    showGoogleMap: function (getData) {
      ...
      // self.zoneInfo[self.zoneInfoPage][getData].showGMap= true;
      console.log(self.showGMClick = self.showGMClick + 1);
      // self.zoneInfo[self.zoneInfoPage][getData].Tel = self.zoneInfo[self.zoneInfoPage][getData].Tel ? '12345678' : self.zoneInfo[self.zoneInfoPage][getData].Tel ;

      self.showGM = self.showGM == false ? true : false;
      // self.zoneInfo[self.zoneInfoPage][getData].showGMap = self.showGM;
